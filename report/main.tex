...
\begin{document}
    ...
    Considering the loose reference infrastructure architecture provided in \Cref{fig:reference-infrastructure-architecture}, we see that we need the following stack:
